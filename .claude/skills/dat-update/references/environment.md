...
local Flutter is rewritten there — and because the lock is tracked and inside the core package's
archive, the dirty file fails `dart pub publish --dry-run` with exit 65. Revert it:
